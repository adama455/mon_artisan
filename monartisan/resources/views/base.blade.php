...
<body>
  ...
  <nav class="d-flex flex-row justify-content-between align-items-center px-5">
    ...
    <a href="{{ route('dashboard') }}" class="nav-link  text-dark" data-placement="top" title="Dashboard">
      <i class="fas fa-home  fs-5"></i><strong class="fs-5">Dashboard</strong>
    </a>
  ...
  <footer class="py-3 my-4">
    ...
    <div class="p-2 w-full pt-8 mt-8 border-t border-gray text-center">
      ...
      <span class="inline-flex">
        <a href="https://www.facebook.com/monartisan.ci" target="_blank" class="text-slate-800">
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
          <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
        </svg>
        </a>
        <a href="https://twitter.com/mon_artisanci" target="_blank" class="ml-4 text-slate-800">
        ...
        <a href="https://www.linkedin.com/company/mon-artisan" target="_blank" class="ml-4 text-slate-800">
